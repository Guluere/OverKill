...
namespace OverKill.Items.Weapons
{
	public class HeavyEdge : ModItem
	{
		...
		{
            DisplayName.SetDefault("Heavy Edge");
            Tooltip.SetDefault("'Iron is weak.'");
            DisplayName.AddTranslation(GameCulture.Spanish, "Heavy Edge");
            Tooltip.AddTranslation(GameCulture.Spanish, "'El hierro es débil.'");
        }
