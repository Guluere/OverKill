...
{
	public class FlyingWhirlwindProjectile : ModProjectile
	{
		...
		public override void Kill(int timeLeft)
		{
			...
			int item =
				Main.rand.Next(100) == 0
					? Item.NewItem((int)projectile.position.X, (int)projectile.position.Y, projectile.width, projectile.height, mod.ItemType<FlyingWhirlwind>())
					: 0;
